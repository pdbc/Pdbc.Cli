...
namespace Pdbc.Cli.App.Roslyn.Generation.Api
{
    public static class ApiRequestTestDataBuilderGenerator
    {
        ...
        {
            var className = service.GenerationContext.ActionInfo.RequestInputClassName.ToTestDataBuilder();
            ...
            entity = new ClassDeclarationSyntaxBuilder()
                ...
                .AddBaseClass($"{service.GenerationContext.ActionInfo.RequestInputClassName.ToBuilder()}")
                .Build();
